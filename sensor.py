...
def get_distance():
	...
	for x in range(20):
		try:
			...
			if(distance > 300):# ignore erroneous readings (max distance cannot be more than 125)
				k=k+1
				continue
...
url_remote="http://192.168.0.197/web_host/watertank/insert_data.php?passcode=" + passcode + "&level="
